...
%{_libdir}/collectd/match_interval.so
%{_libdir}/collectd/match_ipaddress.so
...
- Fix a bug that match_regex cannot match correctly with empty metadata
...
* Tue May 15 2018 Ruben Kerkhof <ruben@rubenkerkhof.com> - 5.8.0-4
- Rebuild for new librabbitmq (#1568379)

* Thu Apr 05 2018 Ruben Kerkhof <ruben@rubenkerkhof.com> - 5.8.0-3
- Fix segfault in Ceph plugin (#1531596)

* Fri Feb 23 2018 Yaakov Selkowitz <yselkowi@redhat.com> - 5.8.0-2
- Enable iptables and virt on aarch64

* Mon Nov 27 2017 Ruben Kerkhof <ruben@rubenkerkhof.com> - 5.8.0-1
- Upstream released new version
- Fixes CVE-2017-16820 (double free in snmp plugin)
- Enable a bunch of new plugins
- Disable pinba plugin on ppc64 (no protobuf-c-devel package)
- Disable write_prometheus plugin on ppc64 (no protobuf-c-devel package)
- Disable write_riemann plugin on ppc64 (no protobuf-c-devel package)

* Thu Jun 08 2017 Ruben Kerkhof <ruben@rubenkerkhof.com> - 5.7.2-1
- Upstream released new version

* Fri Apr 14 2017 Ruben Kerkhof <ruben@rubenkerkhof.com> - 5.7.1-2
- Fix CVE-2017-7401

* Mon Jan 23 2017 Ruben Kerkhof <ruben@rubenkerkhof.com> - 5.7.1-1
- Upstream released new version

* Sun Jan 08 2017 Kevin Fenzi <kevin@scrye.com> - 5.7.0-1
